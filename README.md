...
Aplicación móvil desarrollada para apoyar la gestión y el monitoreo de un invernadero de la Universidad Politécnica de Tecámac. El sistema permite consultar información de las condiciones ambientales del invernadero y controlar determinados dispositivos mediante una interfaz diseñada para facilitar la supervisión de los recursos.
